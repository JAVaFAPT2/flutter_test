...
abstract class AppStrings {
  ...
  // Checkout/Order flow (Figma-specific)
  static const String orderInfoTitle = 'Thông tin đơn hàng';
  static const String orderInputTitle = 'Nhập thông tin đơn hàng';
  static const String orderInfoHelper =
      'Quý khách vui lòng điền đầy đủ và kiểm lại thông tin trước khi đặt hàng';
  static const String rememberInfo = 'Ghi nhớ thông tin của tôi';
  static const String orderNotesHint = 'Ghi chú đặc biệt cho đơn hàng...';
  static const String orderSubtotalLabel = 'Tổng phụ';
  static const String orderDiscountPercentLabel = 'Chiết khấu';
  static const String orderDiscountLabel = 'Giảm giá';
  static const String orderTotalShort = 'Tổng';
  static const String orderPlacedDate = 'Ngày đặt hàng';
  static String stepOfTotal(int step, int total) => 'Bước $step trong $total';

  // Checkout form labels
  static const String recipientFullNameLabel = '*Họ và tên người nhận';
  static const String recipientPhoneLabel = '*Số điện thoại';
  static const String recipientAddressLabel = '*Địa chỉ nhận hàng';
  static const String recipientNotesLabel = 'Ghi chú (nếu có)';
  ...
  static const String orderReceivedSubtitle = 'Đơn hàng đã được đặt';
  static const String orderReceivedTitle =
      'Chúng tôi đã nhận được thông tin đơn hàng của bạn';

  static const String orderPreparingSubtitle = 'Đơn hàng đang được chuẩn bị';
  static const String orderPreparingTitle =
      'Đơn hàng của bạn đang được chuẩn bị';

  static const String orderPackagingSubtitle =
      'Đơn hàng đang trong quá trình đóng gói';
  static const String orderPackagingTitle =
      'Quá trình đóng gói đang được hoàn tất và sớm gửi cho bên vận chuyển';

  static const String orderShippingSubtitle = 'Vận chuyển';
  static const String orderShippingTitle =
      'Đơn hàng đã được giao cho bên vận chuyển';

  static const String orderHandoverSubtitle = 'Chuyển giao';
  static const String orderHandoverTitle =
      'Shipper đã nhận hàng và trên đường giao đến bạn';

  static const String orderDeliveredSubtitle = 'Giao hàng thành công';
  static const String orderDeliveredTitle =
