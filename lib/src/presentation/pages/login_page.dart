    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          // Back button - disabled for login page (entry point)
          Positioned(
            top: 56,
            left: 23,
            child: GestureDetector(
              onTap: () {
                // Login is entry point - do nothing or close app
                // For now, do nothing since login should be the starting point
              },
              child: SmartAssetImage(
