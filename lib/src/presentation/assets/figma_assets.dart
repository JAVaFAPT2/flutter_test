...
// Background (Intro - PNG fallback for reliability on some devices)
const String kPngBackgroundIntro =
    'assets/begin_login_register/main/background.png';

// Product pack (Intro - PNG)
const String kPngProductPack = 'assets/begin_login_register/main/product.png';

// Web icon (Intro - SVG)
const String kSvgWebIcon = 'assets/begin_login_register/main/Web.svg';

// MGF logo (Intro - PNG)
const String kPngLogoMgf = 'assets/begin_login_register/main/Logo MGF.png';

// Info icon (Intro - SVG)
const String kSvgInfoCircle = 'assets/begin_login_register/main/I.svg';

// Register button frame (SVG) (not yet provided — placeholder)
const String kSvgRegisterFrame = '';

/// Login screen assets
const String kSvgBackgroundLogin = 'assets/begin_login_register/login/Nền.svg';
const String kSvgLoginTopRight =
